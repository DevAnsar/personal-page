    ...
    <div className="w-full mt-20">
      <div className="header flex flex-col md:flex-row items-end justify-between mb-12">
        ...
        <div className="text-end">
          <button
            className="flex-shrink-0 px-4 py-2 text-sm md:text-base font-semibold text-white bg-blue-600 rounded-lg shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-blue-200"
            type="submit"
          >
